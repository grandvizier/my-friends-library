...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'library', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d788787748c3692278f404e99c82bff0');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d788787748c3692278f404e99c82bff0');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_d788787748c3692278f404e99c82bff0');
        ...
        $h->setProxyDir('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/jeff/Documents/devel/my-friends-library/web_app/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler.native_file'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\FileSessionHandler('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), '/home/jeff/Documents/devel/my-friends-library/web_app/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $this->get('fos_user.user_checker'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5000a9a6c57f7')), true);
        $instance->setEventDispatcher($this->get('event_dispatcher'));
        return $instance;
    }
    protected function getSecurity_Extra_MetadataFactoryService()
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod',
            ...
            'session.save_path' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'swiftmailer.spool.memory.path' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/diextra',
            ...
            'security.extra.cache_dir' => '/home/jeff/Documents/devel/my-friends-library/web_app/app/cache/prod/jms_security',
