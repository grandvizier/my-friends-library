...
class __TwigTemplate_a475b56a2c8a452b7635ea73021309c1 extends Twig_Template
{
    ...
    <head>
        ...
        // line 3
        if (isset($context["book_title"])) { $_book_title_ = $context["book_title"]; } else { $_book_title_ = null; }
        echo twig_escape_filter($this->env, $_book_title_, "html", null, true);
        echo "</title>
    </head>
    <body>
        Title:
